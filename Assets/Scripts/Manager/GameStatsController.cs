...
public class GameStatsController : MonoBehaviour
{
    ...
    public static void SaveData(PlayerStats playerStats)
    {
        ...
        PlayerPrefs.SetInt("Stats_AmethystCollected", playerStats.GemCollectedByTypes[GemType.Amethyst]);
        PlayerPrefs.SetInt("Stats_GarnetCollected", playerStats.GemCollectedByTypes[GemType.Garnet]);
        PlayerPrefs.SetInt("Stats_TopazCollected", playerStats.GemCollectedByTypes[GemType.Topaz]);
        PlayerPrefs.SetInt("Stats_SpinelCollected", playerStats.GemCollectedByTypes[GemType.Spinel]);
        PlayerPrefs.SetInt("Stats_RubyCollected", playerStats.GemCollectedByTypes[GemType.Ruby]);
        PlayerPrefs.SetInt("Stats_SapphireCollected", playerStats.GemCollectedByTypes[GemType.Sapphire]);
        PlayerPrefs.SetInt("Stats_EmeraldCollected", playerStats.GemCollectedByTypes[GemType.Emerald]);
        PlayerPrefs.SetInt("Stats_DiamondCollected", playerStats.GemCollectedByTypes[GemType.Diamond]);
    ...
    public static PlayerStats LoadData()
    {
        ...
        playerStats.GemCollectedByTypes[GemType.Amethyst] = PlayerPrefs.GetInt("Stats_AmethystCollected", 0);
        playerStats.GemCollectedByTypes[GemType.Garnet] = PlayerPrefs.GetInt("Stats_GarnetCollected", 0);
        playerStats.GemCollectedByTypes[GemType.Topaz] = PlayerPrefs.GetInt("Stats_TopazCollected", 0);
        playerStats.GemCollectedByTypes[GemType.Spinel] = PlayerPrefs.GetInt("Stats_SpinelCollected", 0);
        playerStats.GemCollectedByTypes[GemType.Ruby] = PlayerPrefs.GetInt("Stats_RubyCollected", 0);
        playerStats.GemCollectedByTypes[GemType.Sapphire] = PlayerPrefs.GetInt("Stats_SapphireCollected", 0);
        playerStats.GemCollectedByTypes[GemType.Emerald] = PlayerPrefs.GetInt("Stats_EmeraldCollected", 0);
        playerStats.GemCollectedByTypes[GemType.Diamond] = PlayerPrefs.GetInt("Stats_DiamondCollected", 0);
